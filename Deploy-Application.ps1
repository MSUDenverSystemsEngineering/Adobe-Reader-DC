...
Try {
	...
	[string]$appVersion = '19.021.20056'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '3.7.0.1'
	[string]$appScriptDate = '12/3/2019'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Remove-MSIApplications -Name "Adobe Acrobat Reader" -PassThru
		...
		Execute-MSI -Action 'Install' -Path 'AcroRead.msi' -Transform 'AcroRead.mst' 'REBOOT=ReallySuppress /QN'
		Execute-MSI -Action 'Patch' -Path 'AcroRdrDCUpd1902120056.msp' -Parameters 'REBOOT=ReallySuppress /QN'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBEMzSLMaoFIHqw
# sM1R+AwmVHkYWAPWtM61B5krBUwu26CCFFwwggQUMIIC/KADAgECAgsEAAAAAAEv
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgZMNw+Ikp
# 9rTUMYj6kvCqXAbwVPBc6bhxjqVqFJDroHQwDQYJKoZIhvcNAQEBBQAEggEAuFMV
# F0AJGeWNC0NgEHAjgvankQqEpiCkzurByGHHgR8l4Q/cfPXDDkBhSN7ofYXkhvzr
# Io46p/uNO4H+Ck++SvXggLAX9l5yJ/onsdRCINmbXEOygH7sreSnPni9J3CN2T6L
# wTvfxzsvTg8BY/6EA7iomjM0MdR7UQcthxXhSV+yv3+yLmQN/2yGtMk/GAVnvWXW
# 67lJtnuFzlrWGWXNUOU2Y3PVqncslHIp2MDJHrGZ5sR/7ORXEJKCCAg3kyNPPWfb
# BDTEczEXGOkidEKUx99bGYZKf8FYoRLDwSwunb2XoMCg2RyAOVMdBhpz1fNWacBS
# Bq601E3DMGS++bkuB6GCAqIwggKeBgkqhkiG9w0BCQYxggKPMIICiwIBATBoMFIx
...
# CSqGSIb3DQEJBTEPFw0xOTEyMDMxNzQzNTRaMCMGCSqGSIb3DQEJBDEWBBSJYr+z
# k/j2GY+BzV+zWbLgs7JLKDCBnQYLKoZIhvcNAQkQAgwxgY0wgYowgYcwgYQEFGO4
...
# ggEAY5oqcm8WUoKZAtVQC5nalsXCtxsuqp1uZ9CP/A+bq9lBBJfv8AU45aZ4ICvv
# MjhxfRZbNVekPHWQ+fU757PM87bZV9TFSdH4yTA8fhQ2nOaaaihALaQqTbMKdzG9
# MhcgWmpAr2LYMmwIrOL68WAorKwJNC8ABcN7oUFLjo8NXVcTxQHPlOvy+EJgdN3p
# +BkXWqOgDzESycDEVhrcW4ARF8CQd+ta+EaOKhM5YroHFBp80/Ct4nEIwr52l5OH
# aSe1dk5abt8SPw3qZn3LljgYfI/WLQjoBEpvUiKngiY4gkF73i8RHMclyOKP9qTm
# bKIux0uSaENg5/XGqhSM29hJDA==
